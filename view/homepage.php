        ...
        <div class="search-form" id="searchArea">
            <div class="search-form-wrapper">
                    <span class="input input--isao">
                        <input class="input__field input__field--isao" id="autocomplete" placeholder="" name="city"
                               type="text"/>
                    ...
                    <div class="product-front">
                        ...
                        <div class="stats">
                            <div class="stats-container">
                                ...
                                <p><?php echo TemplateView::noHTML($listing->getStreet() . "," .$listing->getCanton()); ?></p>
                                <div class="product-options">
                                    ...
                                    <span><?php echo TemplateView::noHTML($listing->getMoveindate()); ?></span>
                                </div>
                            </div>
                        </div>
                    </div>
